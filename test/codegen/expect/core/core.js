...
(function (core) {
  ...
  class bool {
    /*constructor*/ fromEnvironment(name, opt$) {
  ...
  class DateTime {
    ...
    /*constructor*/ _internal(year, month, day, hour, minute, second, millisecond, isUtc) {
  ...
  let List$ = dart.generic(function(E) {
    class List {
      ...
      /*constructor*/ filled(length, fill) {
  ...
  class String {
    /*constructor*/ fromCharCodes(charCodes, start, end) {
