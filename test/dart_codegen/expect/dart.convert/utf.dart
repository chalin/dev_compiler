...
class _Utf8Encoder {
  ...
  _Utf8Encoder() : this.withBufferSize(DDC$RT.cast(_DEFAULT_BYTE_BUFFER_SIZE,
          dynamic, int, "CastGeneral",
          """line 143, column 40 of dart:convert/utf.dart: """,
    ...
    loop: while (true) {
      multibyte: if (expectedUnits > 0) {
        ...
        if (value > _FOUR_BYTE_LIMIT) {
          if (!_allowMalformed) {
            throw new FormatException(
                "Character outside valid Unicode range: " "0x${value.toRadixString(16)}");
          }
          value = UNICODE_REPLACEMENT_CHARACTER_RUNE;
        }
